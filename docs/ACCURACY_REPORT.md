...
The system does not rely on a prompt saying "do not modify evidence." The path policy is enforced in Python. Unit tests verify that writes into the evidence root raise `PolicyViolation`.
